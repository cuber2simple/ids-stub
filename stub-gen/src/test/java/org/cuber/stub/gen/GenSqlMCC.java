...
public class GenSqlMCC {
    private static final CSVParser csvParser = new CSVParser();
    private static final String CSV_PATH = "/work/2018/ae/mcc_new.csv";
    private static final String DESC_PATH = "/work/2018/ae/mcc.sql";
    ...
    private static String tran2Sql(String line) {
        ...
        try {
            ...
            List<String> newValues = Arrays.stream(values)
                    ...
                    .collect(Collectors.toList());
            result ="INSERT INTO T_MCC_DEF(ID, MCC_CODE, OFFICIAL_NAME_EN, OFFICIAL_NAME_CN, IS_SYS) values ( nextval('SEQ_MCC_DEF_ID')," +  Joiner.on(",").join(newValues) + ",'true');";
        } catch (Exception e) {
            logger.error("转换出错",e);
        }
        return result;
